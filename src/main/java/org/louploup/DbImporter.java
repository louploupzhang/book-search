...
public class DbImporter {
    ...
    public static void main(String[] args) {
        try {
            System.out.println("Starting the data ingestion...");
            ...
            System.err.println("An error occurred during data ingestion: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    //Inserts the parsed data into the PostgreSQL database, including authors and book_authors tables
            ...
            PreparedStatement bookAuthorStmt = conn.prepareStatement(insertBookAuthorSQL)){
                ...
                for (int i = 1; i < records.size(); i++) {
                    ...
                    if (authorRS.next()) {
                        ...
                        // If the author was not inserted, fetch the ID
                    ...
                    try {
                        ...
                        System.err.println("Invalid publish date format for book: " + title);
                    }

                    try {
                        firstPublishDate = Date.valueOf(firstPublishDateStr);
                    } catch (Exception e) {
                        System.err.println("Invalid first publish date format for book: " + title);
                    }   
